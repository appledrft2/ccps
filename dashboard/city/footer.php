...
<!-- Morris.js charts -->
<script src="<?php echo $baseurl ?>template/bower_components/raphael/raphael.min.js"></script>
<script src="<?php echo $baseurl ?>template/bower_components/morris.js/morris.min.js"></script>
<!-- AdminLTE App -->
