      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <a href="add.php" class="btn btn-danger btn-md"><i class="fa fa-plus-circle"></i> Add Barangay</a>
          </div>
          <div class="box-body">
            <table id="table1" class="table table-bordered">
              <thead>
               ...
               <tbody>
                  <?php 
                    $sql = "SELECT id,name,timestamp FROM tbl_barangay ORDER BY timestamp ASC";
                    $qry = $connection->prepare($sql);
                    $qry->execute();
                    $qry->bind_result($id,$dbn, $dbtimestamp);
                    $qry->store_result();
                    while($qry->fetch ()) {
                      echo"<tr>";
                      echo"<td>";
