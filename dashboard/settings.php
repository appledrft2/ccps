        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                <label style="display:none">User Type <i style="color:red">*</i></label>
...
if(isset($_POST['btnSave'])){
    ...
    if($_POST['password'] != ''){
      ...
      $qry = $connection->prepare($sql);
      $qry->bind_param("ssssssssi",$_POST['firstname'],$_POST['lastname'],$_POST['gender'],$_POST['type'],$_POST['phone'],$_POST['email'],$_POST['username'],$hashed_password,$_SESSION['dbu']);
    }else{
      $sql = "UPDATE tbl_user SET firstname=?,lastname=?,gender=?,type=?,phone=?,email=?,username=? WHERE id=?";
      $qry = $connection->prepare($sql);
      $qry->bind_param("sssssssi",$_POST['firstname'],$_POST['lastname'],$_POST['gender'],$_POST['type'],$_POST['phone'],$_POST['email'],$_POST['username'],$_SESSION['dbu']);
    }
